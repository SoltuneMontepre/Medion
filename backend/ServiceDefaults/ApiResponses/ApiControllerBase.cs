...
public abstract class ApiControllerBase : ControllerBase
{
    ...
    {
        var result = ApiResult<T>.ValidationError(errors ?? [],
            message);
    ...
    /// </summary>
    protected static ObjectResult Unauthorized<T>(string message = "Unauthorized access")
    {
    ...
    /// </summary>
    protected static ObjectResult ApiResponse<T>(ApiResult<T> result)
    {
